...
def jacobian(*args):
    """
    Calculate the Jacobian matrix to determine the differential kinematics of manipulators / robots
    """
    Ts = []
    type = []
    for k in args:
...
def kinematics_inv(J, b, x0, deg = False,eps = 1e-6):
    """
    Calculate the inverse kinematics from a numerical method
